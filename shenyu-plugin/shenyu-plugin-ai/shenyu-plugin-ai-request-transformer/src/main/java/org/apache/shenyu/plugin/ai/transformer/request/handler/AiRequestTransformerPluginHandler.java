 ...
 */
public class AiRequestTransformerPluginHandler extends AbstractAiTransformerPluginHandler {

    public AiRequestTransformerPluginHandler(final AiModelFactoryRegistry registry) {
        super(registry);
    }
